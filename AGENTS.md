...
Source documents and related notes live in the Obsidian vault (see `~/.Codex/AGENTS.md` for the current path on this device). When working with vault files, use the `obsidian:obsidian-markdown` skill.
